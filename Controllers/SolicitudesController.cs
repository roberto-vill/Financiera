...
namespace Financiera.Controllers
{
    public class SolicitudesController : Controller
    {
        ...
        public ActionResult DetailsByState(int? id)
        {
           ...
           switch(id)
            {
                case 1: ViewBag.idEstado = "Inicial"; break;
                case 2: ViewBag.idEstado = "En Analisis"; break;
                case 3: ViewBag.idEstado = "Para Llamar"; break;
                case 4: ViewBag.idEstado = "Desechado"; break;
                case 5: ViewBag.idEstado = "Completo para Cargar"; break;
                case 6: ViewBag.idEstado = "Desistió el Cliente"; break;
                case 7: ViewBag.idEstado = "A Espera de Resultado"; break;
                case 8: ViewBag.idEstado = "Para llamar a Firmar"; break;
                case 9: ViewBag.idEstado = "Desaprobado"; break;
                case 10: ViewBag.idEstado = "Firmado"; break;
                case 11: ViewBag.idEstado = "Prenda a Gestor"; break;
                default: ViewBag.idEstado = "Prenda Inscripta"; break;
            }
